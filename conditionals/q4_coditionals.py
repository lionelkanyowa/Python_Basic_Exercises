# Q.4: Initialize a variable weather with a string value being 'sunny', 'rainy', or whatever weather
# condition you choose. Then, write an if statement that prints:
